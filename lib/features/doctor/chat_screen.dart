...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget _buildHeader(BuildContext context) {
    return Container(color: _headerColor, child: SafeArea(bottom: false, child: Padding(padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12), child: Row(children: [
      ...
      Container(width: 42, height: 42, decoration: BoxDecoration(color: Colors.white, shape: BoxShape.circle, border: Border.all(color: Colors.white, width: 2), image: const DecorationImage(image: AssetImage('assets/doctor (1).png'), fit: BoxFit.cover))),
      const SizedBox(width: 10),
